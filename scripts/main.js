      const translations = {
        ...
        pt: {
          heroMeta: "@chicojunior",
          headline: "Frontend Engineer (Angular + TypeScript) focado em interfaces modernas e escalaveis.",
          heroNote: "Ajudo times a modernizar frontends legados e entregar experiencias claras e confiaveis.",
          ctaContact: "Contato",
          ctaLinkedIn: "LinkedIn",
          ctaGitHub: "GitHub",
          ctaCV: "CV",
          aboutTitle: "Sobre",
          about: "Engenheiro Frontend com mais de 10 anos construindo produtos web no Brasil e na Europa. Foco em clareza de UX, arquitetura sustentavel e entregas consistentes em times de produto.",
          impactTitle: "Destaques de Impacto",
          impactItem1: "Modernizei frontends legados em plataformas Angular e TypeScript com componentes reutilizaveis.",
          impactItem2: "Melhorei a consistencia de entrega dos times ao estruturar arquitetura escalavel e bases de UI compartilhadas.",
          impactItem3: "Entreguei interfaces responsivas e acessiveis para produtos internacionais com foco claro no negocio.",
          recruiterTitle: "Resumo para Recrutadores",
          recruiterSummary: "Engenheiro Frontend com foco em Angular e TypeScript, forte ownership de entrega e exposicao internacional em produtos. Posicionamento: strong mid-level / early senior, com evolucao clara para escopo senior.",
          stackTitle: "Stack Tecnologica",
          stackFrontendTitle: "Frontend",
          stackBackendTitle: "Backend",
          stackToolsTitle: "Ferramentas",
          footer: "Disponivel para oportunidades remotas e hibridas na Europa.",
